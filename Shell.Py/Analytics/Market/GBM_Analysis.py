...
def print_statistics( data ):
	...
	print( "Skew Normal Test p-values	%9.6f" % scs.skewtest( data[ 'returns' ] )[ 1 ] )

	print( "-------------------------------------------------------------------" )
	print( "Kurt of Sample Log Returns	%9.6f" % scs.kurtosis( data[ 'returns' ] ) )
	print( "Kurt Normal Test p-values	%9.6f" % scs.kurtosistest( data[ 'returns' ] )[ 1 ] )
...
# mean return, volatility adn correlation ( 252 days moving = 1 year )
