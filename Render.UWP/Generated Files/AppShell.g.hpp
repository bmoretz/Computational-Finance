...
class RenderEngine::AppShell::AppShell_obj2_Bindings 
    : public ::XamlBindingInfo::ReferenceTypeXamlBindings<::RenderEngine::Controls::NavMenuItem>
...
public:
    ...
    int ProcessBindings(::Windows::UI::Xaml::Controls::ContainerContentChangingEventArgs^ args)
    {
        ...
        switch(args->Phase)
        {
            case 0:
                nextPhase = -1;
                this->SetDataRoot(static_cast<::RenderEngine::Controls::NavMenuItem^>(args->Item));
        ...
        this->Update_((::RenderEngine::Controls::NavMenuItem^) args->Item, (1 << args->Phase));
        return nextPhase;
    }
private:
    ...
    void Update_SelectedVis(::Windows::UI::Xaml::Visibility obj, int phase)
    {
        if((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
        {
            ...
            ::XamlBindingInfo::XamlBindingSetters::Set_Windows_UI_Xaml_UIElement_Visibility(this->obj3, obj);
        }
    }
    void Update_SymbolAsChar(::Platform::String^ obj, int phase)
    {
        if((phase & ((1 << 0) | NOT_PHASED )) != 0)
        {
            ...
            ::XamlBindingInfo::XamlBindingSetters::Set_Windows_UI_Xaml_Controls_FontIcon_Glyph(this->obj4, obj, nullptr);
        }
    }
    void Update_Label(::Platform::String^ obj, int phase)
    {
        ...
        {
            // AppShell.xaml line 38
            ::XamlBindingInfo::XamlBindingSetters::Set_Windows_UI_Xaml_Controls_ToolTipService_ToolTip(this->obj4, obj, nullptr);
